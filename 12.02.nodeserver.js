// this is the file copied from the "javascript-the-definitive-guide-6th"
// run with node 12.02.nodeserver.js
// 这样测试
//  1. delay --  curl http://localhost:8000/test/delay
//  2. test/mirror - curl http://localhost:8000/test/mirror -d'{"code":200}'
//  3. curl http://localhost:8000/12.02.copyFile.js - file download
